...
>(({ className, children, error, success, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "flex h-12 w-full items-center justify-between rounded-lg border bg-background px-4 py-3 text-base ring-offset-background",
      ...
      "min-h-[44px] text-base md:text-sm touch-manipulation",
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        // Modern dropdown styling with enhanced shadows
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      // Enhanced item styling with better touch targets
      "relative flex w-full cursor-default select-none items-center rounded-md py-3 pl-8 pr-2 text-sm outline-none",
